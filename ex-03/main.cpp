...
int main() {
  ...
  std::cout << "Minimum value of dp1: " << dp1.minimum() << std::endl;
  std::cout << "Maximum value of dp1: " << dp1.maximum() << std::endl;
  std::cout << "Mean of dp1: " << dp1.mean() << std::endl;
  std::cout << "Standard deviation of dp1: " << dp1.standard_deviation()
            << std::endl;
  ...
  std::cout << "dp4: " << dp4 << std::endl;
{
    ...
    std::cout << "Minimum value of dp5: " << dp5.minimum() << std::endl;
    std::cout << "Maximum value of dp5: " << dp5.maximum() << std::endl;
